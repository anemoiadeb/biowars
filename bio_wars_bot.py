...
# ══════════════════════════════════════════════════════════════════════════════
#  MAIN  (webhook-режим — без конфликтов при редеплое на Render)
# ══════════════════════════════════════════════════════════════════════════════
...
async def main() -> None:
    ...
    # Сбрасываем старый вебхук/поллинг и ставим новый
    ...
    # Health endpoints (Render проверяет / и /health)
    async def ok(_: web.Request) -> web.Response:
        return web.Response(text="OK")
    app.router.add_get("/",       ok)
    app.router.add_head("/",      ok)
    app.router.add_get("/health", ok)

    # Webhook endpoint — aiogram сам обрабатывает POST /webhook
